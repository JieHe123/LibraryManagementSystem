                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">Personal Management > Revise the password</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                        ...
                                        <td colspan="2">
                                            <form  action="" method="">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px">Original Password：</td>
                                                        <td width="150px"><input class="text" type="password" name="pwd" required/></td>
                                                        <td class="err">*Not match with the original password</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px">New Password Confirmation：</td>
                                                        <td width="150px"><input class="text" type="password" id="newpwd2" name="newpwd2" required /></td>
                                                        <td id="newpwd2_err"class="err">The new password entered is different</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
