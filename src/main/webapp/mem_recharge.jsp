                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">Membership Management > Member Top-up</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/lms/topUp" method="post">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px">ID：</td>
                                                        <td width="150px"><input class="text" type="text" name="idNumber"   required/></td>
                                                        <td class="err">*This ID does not exist</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr> 
                                                  
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="80px"> Top-up Amount:</td>
