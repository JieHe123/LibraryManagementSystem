                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">Membership management > Add new members </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/lms/addMember" method="post">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>Member Type</td>
                                                        <td><input  type="radio" name="memberType" value="1" checked/> Normal Member&nbsp;&nbsp;
														    <input  type="radio" name="memberType" value="2" /> Silver Member&nbsp;&nbsp;
															 <input  type="radio" name="memberType" value="3" />Golden Member
                                                        </td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
